...
Friendship.create!(friender_id: 10, friended_id: 1, responded: false, accepted: false)
Friendship.create!(friender_id: 4, friended_id: 1, responded: true, accepted: true)
